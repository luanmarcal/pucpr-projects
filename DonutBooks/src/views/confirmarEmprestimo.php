...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lobster&family=Righteous&family=Roboto:wght@100&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="../../public/styles/confirmarEmprestimo.css">
    <link rel="icon" type="image/x-icon" href="../../public/images/icon-donut.png">
    <title>Confirmar Empréstimo - Donut Books</title>
</head>
...
<body>
    <main class="conteudo">
        ...
        <div class="table">
            <table>
                <caption>confirmar empréstimo</caption>
                <tr>
                    <th>livro</th>
                    <th>proprietário</th>
                    <th>empréstimo</th>
                ...
                <form action="" method="POST">
                    <?php include('../config/mountEmprestimo.php'); ?>
            </table>

            <?php include('../config/updateEmprestimoBook.php'); ?>

            <div class="input-group">
                <button class="button2" type="submit" name="confirmar">confirmar</button>
            </div>
            </form>

            <div class="input-group">
                <a href="./home.php" class="button2" type="submit">cancelar</a>
            </div>
